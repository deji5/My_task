...
# THE CLASS
"""it is a blue print template that defines what something to look like and 
what it can do"""

"""it defines what something should look like not what it is """

# Object/instance
"""An object /instance is specific, real time created from a class blueprint.
it's the actual things you can  use and interact with."""

# whats is init 
"""init is a special method (called contractor) that auto matically runs when 
...
"""SELF
It is a reference to the specific object you are working with.
its like saying "this particular student" or"this specific bank" 
"""
...
# ATTRIBUTES
"""They are the characteristics, properties, or data that descibe an object.
They answer the question "what does a object look like?"  or "what information 
does object store" """
...
class Student:
    ...
    def __init__(self, name, course, student1, student2):
        self.name = name         
        self.course = course
...
"""
METHOD: THE ACTIONS(WHAT OBJECT CAN DO)
whats Methods?
methods are functions that belong to a class.
they define what actions an object can perform.
they answer the question "what can this object do."
"""
class Student:
    def __init__(self, name, course, level):
        # Attributes
...
def academic_calendar():
    return"Aademic session runs from september to july"
...
"""Encapsulation 
it is like putting related items in a box and controlling who access them. It 
groups related data (attributes) and functions (methods) together in one class,
and controls how they can be accessed from outside.
"""
...
"""ABSTRACTION
It means hiding complex implementation details and showing only the essential
features. Its like using a remote control -you press buttons to change channels,
but you dont need to know how the TV circuits work.
"""
...
class SimplePhone:
    ...
    def make_call(self, number):
        ...
        return f"SMS sent to {number} from {self.brand} phone"
    
    def send_sms(self, message, number):
        self._cennect_to_sms_center()
        self._format_message()
        self._send_through_network()
        return f"SMS sent to {number}: '{message}'"
    
    #Complexinternal methods - hidden from user
    def _establish_network_connection(self):
        # Complex netorking code here
        pass
    ...
    def _transmit_to_tower(self):
        ...
        pass
    def _cennect_to_sms_center(self):
        # Complex netorking code here
        pass
...
my_phone =  SimplePhone("Tenco")
print(my_phone.make_call("080812345678"))   # Simple to use 
# print(my_phone.send_sms("Howfar?", "08098765432"))  Dont need to know internals
